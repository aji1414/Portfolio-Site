...
const AboutMe = () => (
    <div className="about-me mx-auto">
        ...
        <a target="_blank" className="downloadLink" href="https://drive.google.com/file/d/1H8AI9yH_jLDFtCpv8NXpM9vMNOaQCfIB/view?usp=sharing" download><CustomButton className="buttons">Download CV</CustomButton></a>
    </div>
);
