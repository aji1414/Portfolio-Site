        ...
        <div className="job d-flex row">
            <div className="job-info col-11 d-flex flex-column">
                <div className="title-and-location-box row">
                    ...
                    <div className="col-6 col-md-4"><h5 className="job-title">{children}</h5></div>
                    <div className="col-4 col-md-4 job-location">{jobLocation}</div>
                    <div className="d-none d-md-inline col-md-3 job-duration text-center">{jobDates}</div> 
                </div>
