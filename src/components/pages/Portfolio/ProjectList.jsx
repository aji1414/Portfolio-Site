...
import awitter from "../../../assets/portfolioThumbnails/awitter.jpg";
...
const projectList = [
    ...
    { description: "Basic twitter clone web app", name: "Awitter", thumbnail: awitter, visible: true, link: "https://aji1414.github.io/awitter/#/", tech: ["ALL", "REACT", "FIREBASE", "HTML/CSS"] }
];
